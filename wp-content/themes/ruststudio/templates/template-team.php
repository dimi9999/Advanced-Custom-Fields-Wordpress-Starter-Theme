	...
	<main>
	   <div>
		  ...
		  <div class="col-right bg-light">
			 <div>
			 <!-- Images -->
				<?php $team_image_1 = get_field('team_image_1'); ?>
				<?php $team_image_2 = get_field('team_image_2'); ?>
				<?php $team_image_3 = get_field('team_image_3'); ?>
				<?php $team_image_4 = get_field('team_image_4'); ?>
				
				<?php if ($team_image_1) : ?>
				
				<img class="block story-img" src="<?php echo $team_image_1 ?>" alt="<?php echo $team_title ?>" title="<?php echo $team_title ?>" />
				<?php endif ?>
				<?php if ($team_image_2) : ?>
				<img class="block story-img" src="<?php echo $team_image_2 ?>" alt="<?php echo $team_title ?>" title="<?php echo $team_title ?>" />
				<?php endif ?>
				<?php if ($team_image_3) : ?>
				<img class="block story-img" src="<?php echo $team_image_1 ?>" alt="<?php echo $team_title ?>" title="<?php echo $team_title ?>" />
				<?php endif ?>
				<?php if ($team_image_4) : ?>
				<img class="block story-img" src="<?php echo $team_image_4 ?>" alt="<?php echo $team_title ?>" title="<?php echo $team_title ?>" />
				<?php endif ?>
			 </div>
		  </div>
